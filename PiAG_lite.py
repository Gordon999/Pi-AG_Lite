...
scale      = 100     # mS/pixel
fps        = 12
mode       = 2       #['off',  'auto', 'night', 'sports', 'verylong', 'fireworks']
speed      = 80000  # mS * 1000
...
if not os.path.exists('PiAGconfig.txt'):
    points = [crop,threshold,scale,fps,mode,speed,ISO,brightness,contrast,Night,Auto_G,min_corr,interval,InvRA,InvDEC,preview,c_mask]
...
def func1(correct,q):
  global preview,RAon,DECon,mask,frames,widths,modes,scale,ISO,speed,fps,brightness,contrast,width,height,zoom,xo,yo,b,crop,a,x,y,w,h,dim,threshold,InvRA,InvDEC,scalex,scale,Auto_G,RAstr,DECstr,min_corr,Night,mode,interval
